    ...
    <SimpleGrid columns={2} spacing="4">
        ...
        <Box>
          <Link href={LINKS.cw721Token(collection.id, collection.featured)}>
            <FallbackImage
              ...
              alt={token?.metadata?.name || 'Featured Hero Token Image'} // Changed alt text
              borderRadius="lg"
              maxW="sm"
              boxShadow="md"
              cursor="pointer"
      ...
      <GridItem>
        <Box maxW="sm" ml="auto" position="sticky" top="4">
          {/* This component's internal text/labels are not part of this file to change directly */}
          <Cw721TokenAction
...
const Featured: FC<Props> = (props) => {
  ...
  return (
    <VStack alignItems="stretch" gap={4}>
      {/* No direct text elements in this component to change, it renders FeaturedItem components */}
